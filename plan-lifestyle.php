...
<title>BorvoCare - Plans - Lifestyle</title>
...
<div class="main"> 
  <!-- Banner start -->
  <section class="banner banner-inner banner-lifestyle"> </section>
  <!-- Banner end --> 
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 wow fadeInUp" data-wow-delay="200ms">
          <div class="icon-circle lifestyle"><img src="imgs/icon-lifestyle-white.svg"></div>
          <h1 class="text-lifestyle font-bold mb3">Lifestyle</h1>
            <p class="mb2">It's important to look, feel good and be comfortable with yourself to increases happiness.</p>
        <ul class="list lifestyle">
          <li>Personalizing your style</li>
          <li>Cosmetology consult</li>
          <li>Monthly Basic Grooming</li>
          <li>Spa Treatment</li>
          <li>Detox Course</li>
          <li>Monthly hobby classes for your little ones</li>
          <li>Family portrait shoot</li>
        </ul>
        </div>
